...
def _compile_deep_gemm_one_type_all(
    ...
    try:
        ...
        # `get_compile_mode` / `set_compile_mode` were removed in the
        # PR #324 sm120 branch (deepgemm 2.5.0). When unavailable, the JIT
        # uses its built-in default — skip the compile-mode hint.
