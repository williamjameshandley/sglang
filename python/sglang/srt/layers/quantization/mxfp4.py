...
class Mxfp4MoEMethod(FusedMoEMethodBase):
    ...
    def create_moe_runner(
        ...
        # Phase 7.4.10.1: per-layer custom op registration for sm_120 PCG
        # path. Idempotent — also called from process_weights_after_loading;
        # whichever completes the prerequisites second performs the
        # registration.
        self._maybe_register_deepseek_v4_moe_pcg_op(layer)
